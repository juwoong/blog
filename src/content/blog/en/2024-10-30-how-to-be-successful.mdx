...
pubDate: 2024-10-30 14:40:00+0900
description: ""
tags: [idea, growth, translation]
slug: "how-to-be-successful"
originalArticleUrl: "https://blog.samaltman.com/how-to-be-successful"
---

[Original article](https://blog.samaltman.com/how-to-be-successful) translated using GPT.

---

I've observed thousands of founders and thought a lot about what it takes to make a huge amount of money or to create something important. Usually, people start out wanting the former and end up wanting the latter.
...
I remember when Elon Musk took me on a tour of the SpaceX factory many years ago. He talked in detail about manufacturing every part of the rocket, but the thing that struck me most was the look of absolute certainty on his face when he talked about sending large rockets to Mars. I left thinking "huh, so that's the benchmark for what conviction looks like."
...
Self-belief must be balanced with self-awareness. I used to hate criticism of any kind and actively avoided it. Now I try to always listen to it with the assumption that it's true, and then decide if I want to act on it or not. Truth-seeking is hard and often painful, but it is what separates self-belief from self-delusion.

This balance also helps you avoid coming across as entitled and out of touch.

## 3. Learn to think independently

Entrepreneurship is very difficult to teach because original thinking is very difficult to teach. School is not set up to teach this—in fact, it generally rewards the opposite. So you have to cultivate it yourself.
...
Getting good at sales is like getting good at anything else—anyone can get better with practice. But for some reason, perhaps because it feels distasteful, many people treat it as something unlearnable.
...
And it's often really fun. One of the great joys in life is finding your purpose, excelling at it, and discovering that your impact matters to something larger than yourself. A YC founder recently expressed great surprise about how much happier and more fulfilled he was after leaving a large company and working toward his maximum possible impact. Working hard at that should be celebrated.

It's not entirely clear to me why working hard has become a Bad Thing in certain parts of the US, but this is certainly not the case in other parts of the world—the amount of energy and drive exhibited by entrepreneurs outside of the US is quickly becoming the new standard.
...
Ask for what you want. You will usually not get it, and often the rejection will be painful. But when this works, it works surprisingly well.

Almost always, the people who say "I am going to keep going until this works, and no matter what the challenges are I'm going to figure them out", and mean it, go on to succeed. They are persistent long enough to give themselves a chance for luck to go their way.

Airbnb is my benchmark for this. There are so many stories they tell that I wouldn't recommend trying to reproduce (keeping maxed-out credit cards in those nine-slot カード holders made for baseball cards, eating dollar store cereal for every meal, battling with powerful entrenched interest groups) but they managed to survive long enough for luck to go their way.

To be willful, you have to be optimistic—hopefully this is a personality trait that can be improved with practice. I have never met a very successful pessimist.
...
Most people do whatever most people they hang out with do. This mimetic behavior is usually a mistake—if you're doing the same thing everyone else is doing, you're not going to be hard to compete with.
...
A special case of developing a network is finding someone eminent to take a bet on you, ideally early in your career. The best way to do this, no bar none, is to go out of your way to be helpful. (And remember that you have to pay this forward at some point later!)

Finally, remember to spend your time with positive people who support your ambitions.

## 12. You get rich by owning things

The biggest economic misunderstanding of my childhood was that people got rich from high salaries. Though there are some exceptions—entertainers being the most obvious—almost no one in the history of the Forbes list has gotten there with a salary.
...
The best way to make things that increase rapidly in value is to make things people want at scale.

## 13. Be internally driven

Most people are primarily externally driven—they do what they do because they want to impress other people. This is bad for many reasons, but here are two important ones.

First, you will work on consensus ideas and on consensus career tracks. You will care a lot—Loss, more than you realize—about whether other people think you're doing the right thing. This will probably prevent you from doing truly interesting work, and even if you do, someone else would have done it anyway.
...
Smart people seem to be especially at risk of such externally-driven behavior. Being aware of it helps, but only a little—you will likely have to work very hard to not fall into the mimetic trap.
...
**Jessica Livingston** and **Paul Graham** are my benchmarks for this. YC was widely mocked for the first few years, and almost no one thought it would be a big success when they first started. But they thought it would be great for the world if it worked, and they loved helping people, and they were convinced the new model was better than the existing model.

Eventually, you will define your success by performing excellent work in things that are important to you. The earlier you can start off in that direction, the further you will be able to go. It is hard to be wildly successful at anything you aren't obsessed with.
